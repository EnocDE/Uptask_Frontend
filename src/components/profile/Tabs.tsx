    ...
    <div className='mb-10'>
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          name="tabs"
          className="block w-full rounded-md p-3 bg-white focus:outline focus:outline-2 focus:outline-fuchsia-200 border-gray-300 focus:border-purple-800 focus:ring-purple-800"
